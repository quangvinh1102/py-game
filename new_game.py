...
while running:
    ...
    y_dot3 = y_dot2
    if ve and ve1:
        pygame.draw.rect(screen, BLACK, (x_dot1,y_dot1,5,5))
        pygame.draw.rect(screen, BLACK, (x_dot2,y_dot2,5,5))
        pygame.draw.rect(screen, BLACK, (x_dot3,y_dot2,5,5))
        pygame.draw.rect(screen, BLACK, (x_dot4,y_dot4,5,5))
        pygame.draw.rect(screen, BLACK, (x_dot5,y_dot5,5,5))
        pygame.draw.rect(screen, BLACK, (x_dot6,y_dot6,5,5))
